...
{
    class EB_PAIKALLAVALULAPIVIENTI_INP
    {
        public const string PAIKcomponent = @"" +
            @"page(""TeklaStructures"","""")" + "\n" +
            @"{" + "\n" +
            @"	detail(1, EB_PAIKALLAVALULAPIVIENTI)" + "\n" +
            @"	{" + "\n" +
            @"		helpurl(""sewatek_help.chm::/paikallavalulapivienti.htm"")" + "\n" +
            @"" + "\n" +
