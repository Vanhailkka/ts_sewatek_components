...
{
    [Plugin("EB_SEINALAPIVIENTI_MOD_K120")]
    [PluginUserInterface(EB_SEINALAPIVIENTI_MOD_K120_INP.SMODK120component)]

    public partial class EB_SEINALAPIVIENTI_MOD_K120 : PluginBase
    {
        #region Fields
        ...
        private const double _H = 160;
        private const double _B = 120;

        #endregion

        #region Constructor
        public EB_SEINALAPIVIENTI_MOD_K120(StructuresData PluginData)
        {
        ...
        private void GetValuesFromDialog()
        {
            ...
            if (!IsDefaultValue(_Data.P1a))
                ...
                _NameAttribute = "SEINALAPIVIENTI_MOD_K120";
