...
using var = Tekla.Structures.Geometry3d;
using System.Globalization;

namespace Sewatek_components
{
    [Plugin("EB_SEINALAPIVIENTI_SAH_3R")]
    [PluginUserInterface(EB_SEINALAPIVIENTI_SAH_3R_INP.SAH3Rcomponent)]

    public partial class EB_SEINALAPIVIENTI_SAH_3R : PluginBase
    {
        #region Fields
        ...
        #region Constructor
        public EB_SEINALAPIVIENTI_SAH_3R(StructuresData PluginData)
        {
        ...
        private void GetValuesFromDialog()
        {
            ...
            if (!IsDefaultValue(_Data.P2a))
               ...
               _DescriptionAttribute = "1 + 6, 3R, S200";
