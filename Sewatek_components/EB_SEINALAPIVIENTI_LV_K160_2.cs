...
{
    [Plugin("EB_SEINALAPIVIENTI_LV_K160_2")]
    [PluginUserInterface(EB_SEINALAPIVIENTI_LV_K160_2_INP.SLVK160component)]

    public partial class EB_SEINALAPIVIENTI_LV_K160_2 : PluginBase
    {
        #region Fields
        ...
        #region Constructor
        public EB_SEINALAPIVIENTI_LV_K160_2(StructuresData PluginData)
        {
        ...
        public override bool Run(List<InputDefinition> Input)
        {
            try
            {
                ...
                for (int j = 1; j <= 4; j++)
                {
                   ...
                   if (j == 1)
                   {
                      beam = CreatePutki(pt, "100", "pipe" + j);
                   }
                   else
                   {
                      beam = CreatePutki(pt, "0", "pipe" + j);
                   }
                   Parts.Add(beam);
                    Welds.Add(new Weld());
                    Xdist += _Xd;
                ...
                var mainPipe = Parts[0] as Beam;
                InsertUserdefinedAttributes(mainPipe);
        ...
        private void SetDefaultEmbedPartAttributes(Part part, string partClass, string label)
        {
